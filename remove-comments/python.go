...
type RemoveCommentsPython struct {
	nameFile        string
	originalContent string
	cleanedContent  string
}

func newRemoveCommentsPython(nameFile string) *RemoveCommentsPython {
...
func (rc *RemoveCommentsPython) isInsideString(line string, position int) bool {
	inSingleQuote := false
	inDoubleQuote := false
...
func (rc *RemoveCommentsPython) removeCommentsFromLine(line string) (string, bool) {
...
func (rc *RemoveCommentsPython) isDocstring(line string, prevLines []string) bool {
	trimmed := strings.TrimSpace(line)
...
func (rc *RemoveCommentsPython) skipDocstring(lines []string, startIndex int) int {
...
func (rc *RemoveCommentsPython) Remove() string {
...
func (rc *RemoveCommentsPython) GetCleanedContent() string {
	return rc.cleanedContent
}

func (rc *RemoveCommentsPython) GetOriginalContent() string {
	return rc.originalContent
}

func (rc *RemoveCommentsPython) SaveToFile(outputPath string) error {
	return os.WriteFile(outputPath, []byte(rc.cleanedContent), 0644)
}

func (rc *RemoveCommentsPython) ReplaceOriginal() error {
